...
echo.
echo.
echo                                        %COL%[90m iyuvium is a free and open-source desktop utility
...
IF "%local%" gtr "%localtwo%" (
	...
	if !choice! equ 1 (
		curl -L -o %0 "https://github.com/yustinbieber/iyuvium/releases/latest/download/boost.bat" >nul 2>&1
		call %0
		exit /b
	)
	Mode 130,45
...
:MainMenu
Mode 130,45
TITLE Iyuvium Boost Panel %localtwo%
set "choice="
cls
echo.
echo.
...
echo %NPIOF% | find "N/A" >nul && if "%choice%" geq "10" if "%choice%" leq "15" call :IyuviumError "You don't have an NVIDIA GPU" && goto Tweaks
...
:PowerPlan
echo %PWROF% | find "N/A" >nul && call :IyuviumError "You are on AC power, this power plan isn't recommended." && goto Tweaks
curl -g -k -L -# -o "C:\Hone\Resources\HoneV2.pow" "https://github.com/yustinbieber/iyuvium/raw/main/Files/HoneV2.pow" >nul 2>&1
...
if "%TMROF%" equ "%COL%[91mOFF" (
	if not exist SetTimerResolutionService.exe (
		...
		curl -g -L -# -o "C:\Hone\Resources\SetTimerResolutionService.exe" "https://github.com/yustinbieber/iyuvium/raw/main/Files/SetTimerResolutionService.exe" >nul 2>&1
...
call :IyuviumRestart "KBoost" "%KBOOF%" && goto Tweaks
...
:AMD
echo %AMDOF% | find "N/A" >nul && call :IyuviumError "You don't have an AMD GPU" && goto Tweaks
...
:Intel
echo %DSSOF% | find "N/A" >nul && call :IyuviumError "You don't have an intel GPU" && goto Tweaks
...
if "%MITOF%" equ "%COL%[91mOFF" (
	...
	cd %temp%
	if not exist "%temp%\NSudo.exe" curl -g -L -# -o "%temp%\NSudo.exe" "https://github.com/yustinbieber/iyuvium/raw/main/Files/NSudo.exe"
...
if "%NPIOF%" equ "%COL%[91mOFF" (
	...
	curl -g -L -# -o "C:\Hone\Resources\nvidiaProfileInspector\Latency_and_Performances_Settings_by_Hone_Team2.nip" "https://raw.githubusercontent.com/yustinbieber/iyuvium/main/Files/Latency_and_Performances_Settings_by_Hone_Team2.nip"
	cd "C:\Hone\Resources\nvidiaProfileInspector\"
...
::https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest/download/nvidiaProfileInspector.zip
	...
	powershell -NoProfile Expand-Archive 'C:\Hone\Resources\nvidiaProfileInspector.zip' -DestinationPath 'C:\Hone\Resources\nvidiaProfileInspector\'
	del /F /Q "C:\Hone\Resources\nvidiaProfileInspector.zip"
	curl -g -L -# -o "C:\Hone\Resources\nvidiaProfileInspector\Base_Profile.nip" "https://raw.githubusercontent.com/yustinbieber/iyuvium/main/Files/Base_Profile.nip"
	cd "C:\Hone\Resources\nvidiaProfileInspector\"
...
call :IyuviumRestart "Memory Optimization" "%ME2OF%"
goto Tweaks
...
curl -g -k -L -# -o "%temp%\project.reg" "https://raw.githubusercontent.com/yustinbieber/iyuvium/main/Files/Settings/ProjectProperties17.reg"
...
curl -g -k -L -# -o "%temp%\project.reg" "https://raw.githubusercontent.com/yustinbieber/iyuvium/main/Files/Settings/ProjectProperties18.reg"
...
curl -g -k -L -# -o "%temp%\Hone.veg" "https://github.com/yustinbieber/iyuvium/raw/main/Files/Settings/Hone.veg"
...
call :IyuviumRestart "PStates 0" "%PS0OF%" && goto Advanced
...
call :IyuviumRestart "CStates" "%CS0OF%" && goto Advanced
...
title Executing DDU...
curl -g -L -# -o "C:\Hone\Resources\DDU.zip" "https://github.com/yustinbieber/iyuvium/raw/main/Files/DDU.zip"
...
:Minecraft
if not exist "%appdata%\.minecraft\" call:IyuviumError "Can't find your Minecraft installation." & goto GameSettings
...
echo.
echo.
echo                  %COL%[33m[ %COL%[37m3 %COL%[33m] %COL%[37mBackup                                                  %COL%[33m[ %COL%[37m5 %COL%[33m] %COL%[37mCredits
...
cls
echo About
echo Owned by Iyuvium.
echo This is a GUI for the Iyuvium Manual Tweaks.
echo.
...
if not exist "%temp%\restart64.exe" curl -g -L -# -o "%temp%\Restart64.exe" "https://github.com/yustinbieber/iyuvium/raw/main/Files/restart64.exe"
